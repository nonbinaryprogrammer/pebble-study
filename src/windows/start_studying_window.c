...
static ToDo item_arr[] = {
  {"Lab #6", "Chapter 16, #1, 3, 5a", "321", "MTH", 2, 0, 1, 0, 0},
  {"Homework #3", "Chapter 12, #3, 4b, 5de, 6, 7, 11", "321", "MTH", 2, 30, 1, 0, 0},
  {"OTP Implementation", "OTP and Socket communication implementation in C", "344", "CS", 6, 0, 1, 0, 0}
};
...
static void window_load(Window *window) {
  ...
  if(s_inum != -1) {
    ...
    snprintf(s_card_text, sizeof(char)*200, "there are no items\nin your todo list");
  }
